...
export const MSME_SCREEN_COPY = {
  ...
  invoiceForm: {
    detailsTitle: { en: "Invoice details", hi: "इनवॉइस विवरण" },
    ...
    lineItems: { en: "Line items", hi: "आइटम" },
    addLine: { en: "Add line", hi: "लाइन जोड़ें" },
    description: { en: "Description", hi: "विवरण" },
    quantity: { en: "Qty", hi: "मात्रा" },
    unit: { en: "Unit", hi: "इकाई" },
    unitPrice: { en: "Unit price (₹)", hi: "यूनिट मूल्य (₹)" },
    gstRate: { en: "GST %", hi: "GST %" },
    submit: { en: "Create invoice", hi: "इनवॉइस बनाएं" },
    submitting: { en: "Creating…", hi: "बन रहा है…" },
    selectCustomer: { en: "Select customer", hi: "ग्राहक चुनें" },
    pdfNote: { en: "UPI QR appears on PDF when UPI ID is set in Settings.", hi: "सेटिंग्स में UPI ID होने पर PDF पर QR दिखेगा।" },
  },
  payment: {
    recordTitle: { en: "Record payment", hi: "पेमेंट दर्ज करें" },
    recordDesc: { en: "Record a payment received against this invoice.", hi: "इस इनवॉइस के विरुद्ध प्राप्त पेमेंट दर्ज करें।" },
    amount: { en: "Amount (₹)", hi: "राशि (₹)" },
    method: { en: "Payment method", hi: "पेमेंट विधि" },
    paidOn: { en: "Paid on", hi: "भुगतान तिथि" },
    reference: { en: "Reference (optional)", hi: "संदर्भ (वैकल्पिक)" },
    note: { en: "Note (optional)", hi: "नोट (वैकल्पिक)" },
    submit: { en: "Record payment", hi: "पेमेंट दर्ज करें" },
    cancelInvoice: { en: "Cancel invoice", hi: "इनवॉइस रद्द करें" },
  ...
  compliance: {
    pageTitle: { en: "Compliance center", hi: "कंप्लायंस केंद्र" },
    healthScore: { en: "Health score", hi: "हेल्थ स्कोर" },
    overdue: { en: "Overdue filings", hi: "बकाया फाइलिंग" },
    ...
    entityType: { en: "Entity type", hi: "इकाई प्रकार" },
    turnover: { en: "Turnover band", hi: "टर्नओवर श्रेणी" },
    gstrFrequency: { en: "GSTR-1 frequency", hi: "GSTR-1 आवृत्ति" },
  },
  pdf: {
    download: { en: "Download PDF", hi: "PDF डाउनलोड" },
    downloading: { en: "Preparing PDF…", hi: "PDF तैयार हो रहा है…" },
    taxInvoice: { en: "Tax invoice", hi: "कर इनवॉइस" },
  },
} as const;
